...
namespace sdds {
    ...
    public:
        // Constructors
        Status(const char* description = nullptr); // Default constructor with optional parameters
    ...
    // Friend Functions
    std::ostream& operator<<(std::ostream& os, const Status& status); // Overloads the << operator for output
}
